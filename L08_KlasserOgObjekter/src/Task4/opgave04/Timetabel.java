...
public class Timetabel {
    ...
    private static Departure[] getDepartures() {
        //Fejlen var, at der stod "10" i arrayet nedenunder, selvom der kun er 8 valgmuligheder
        // der kom derfor sådan et breakpoint fejl. Da jeg ændrede det til 8 forsvandt fejlen.
