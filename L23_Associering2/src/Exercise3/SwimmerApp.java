...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        for (Swimmer s : swimmers) {
            System.out.println(s.getName() + "'s ugentlige træningstimer er: " + s.allTrainingHours());
        }
        ...
        System.out.println(s3.getTrainingPlan());
        s2.setTrainingPlan(null);
        System.out.println(s2.getTrainingPlan());
